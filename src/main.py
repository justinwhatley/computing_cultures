...
def get_path(computer_str):
    ...
    mac_data_path = '/Users/justinwhatley/Dropbox'
    linux_data_path = '/home/justin/Dropbox'
    
    if computer_str.lower() == 'mac':
        return path.join(mac_data_path)

    elif computer_str.lower() == 'linux': 
        return path.join(linux_data_path)
...
def load_main_altmetric(base_path):
...
def load_acm_new(base_path):
    # Gets main list of dictionary keys
    global final_key_list 

    # Loads ACM_new data sheet
    extention = '.xlsx'
    data_filename = path.join(base_path, 'Bibliometrics' + extention)
...
def load_ieee_explore(base_path):
    # Gets main list of dictionary keys
    global final_key_list 
...
if __name__ == '__main__':
    ...
    print('********************************************')
    inspec_dict_list = load_inspec(base_path)
    ...
    print('********************************************')
    ieee_dict_list = load_ieee_explore(base_path)
